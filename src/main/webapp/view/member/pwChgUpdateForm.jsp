    ...
    <form action="password">
      <div class="container">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control mb-4" id="pass" name="pass">
        </div>
        <!-- 변경 비밀번호-->
        <div class="form-group">
          <label class="mb-1" for="chgpass">변경 비밀번호</label>
          <input type="password" class="form-control mb-4" id="chgpass" name="chgpass" placeholder="8~16자 영소문자/숫자 조합 특수문자 불가">
        </div>
        <!-- 변경 비밀번호 재입력 -->
        <div class="form-group">
          <label class="mb-1" for="chgpass2">변경 비밀번호 재입력</label>
          <input type="password" class="form-control mb-3" id="chgpass2" name="chgpass2">
          <br>
