      ...
      <div class="row row-broken">
        <div class="col-sm-3 col-xs-12">
          <div class="col-inside-lg decor-default chat" style="overflow: hidden; outline: none;" tabindex="5000">
            ...
            <h6>쪽지함</h6>
              <button type="button" class="btn btn-success position-relative" id="msgBtn">
  				쪽지함
          ...
          <div class="col-inside-lg decor-default">
            <div class="chat-body">
              ...
              <div class="answer-add">
                <input placeholder="메세지를 입력하세요." id="input" name="content" size="60" style="width: 800px;">
                
                <input type="hidden" name="receiver" value="${receiver }" id="message">
                <span class="answer-btn answer-btn-1">
                	<button type="submit" id="btn" class="btn btn-outline-light">send</button>
                </span>
